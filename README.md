To run the project please follow below points-

install node version 16.9.1 LTS version .msi installer file
...
if any package is not installing and showing error on npm start, install them individually as much as possible with command--
